...
# v1 covers English + Assamese as a demonstration of the pattern; the
# same dict structure extends to Bodo, Khasi, Mizo, Manipuri, etc.
# ----------------------------------------------------------------------
LABELS = {
    "English": {
...
with st.sidebar:
    language = st.selectbox("Language / ভাষা", list(LABELS.keys()))
